        ...
        <main>
            <nav class="nav">
                <ul class="nav__list container">
                    ...
                    <li class="nav__item">
                        <a href="category.php?id=<?=$category_item['id']; ?>"><?=$category_item['name']; ?></a>
                    </li>
                    <?php endforeach; ?>
                </ul>
            </nav>
            <div class="container">
                            ...
                            <div class="lot__info">
                                ...
                                <div class="lot__state">
                                    <div class="lot__rate">
                                        ...
                                        <span
                                            class="lot__cost"><?=htmlspecialchars(format_number($lot['max_price'] ?? $lot['start_price'])); ?></span>
                                    </div>
                ...
                <ul class="pagination-list">
                    ...
                    <li
                        class="pagination-item <?php echo (intval($page) === intval($cur_page)) ? 'pagination-item-active' : '' ?>">
