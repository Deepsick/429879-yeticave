...
<body>
    ...
    <div class="page-wrapper">
        ...
        <main>
            ...
            <form class="form container <?=$form_class; ?>" action="../sign-up.php" method="post"
                enctype="multipart/form-data">
                <h2>Регистрация нового аккаунта</h2>
                <div class="form__item <?=$email_class; ?>">
                    <label for="email">E-mail*</label>
                    <input id="email" type="email" name="email" placeholder="Введите e-mail" value="<?=$email_value; ?>"
                        required>
                ...
                <div class="form__item <?=$name_class; ?>">
                    ...
                    <input id="name" type="text" name="name" placeholder="Введите имя" value="<?=$name_value; ?>"
                        required>
                ...
                <div class="form__item <?=$contacts_class; ?>">
                    ...
                    <textarea id="message" name="contacts" placeholder="Напишите как с вами связаться"
                        required><?=$contacts_value; ?></textarea>
