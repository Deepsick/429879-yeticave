    ...
    <div class="page-wrapper">
        ...
        <main>
            ...
            <form class="form form--add-lot container <?=count($errors) ? "form--invalid" : ""; ?>" action="../add.php"
                ...
                <div
                    class="form__item form__item--wide <?=!empty($errors['description']) ? "form__item--invalid" : ""; ?>">
                ...
                <div class="form__container-three">
                    ...
                    <div
                        class="form__item form__item--small <?=!empty($errors['start_price'])? "form__item--invalid" : ""; ?>">
                    ...
                    <div
                        class="form__item form__item--small <?=!empty($errors['bet_step']) ? "form__item--invalid" : ""; ?>">
